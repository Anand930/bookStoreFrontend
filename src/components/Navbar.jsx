...
const Navbar = () => {
  ...
  return (
    <div
      className={`max-w-screen-2xl mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 ${
        sticky
      ...
      <div className="navbar ">
        ...
        <div className="navbar-end space-x-3">
          ...
          <div className="hidden md:block">
            <label className="flex items-center px-3 py-2 gap-2 rounded-md border ">
              <input
                type="text"
                className={`grow outline-none ${
                  sticky ? "dark:bg-slate-900" : "dark:text-white"
                } `}
                placeholder="Search"
              />
              <svg
